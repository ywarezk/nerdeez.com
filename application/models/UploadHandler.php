...
class Application_Model_UploadHandler
{
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null) {
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            //set the file name to be wiwth a prefix random number 
            //yariv
    ...
    public function delete() {
        ...
        if (!Application_Model_KSFunctions::getInstance() -> is_IdValid($serial)){
            return;
        }
        ...
        foreach ($_SESSION['kstempfiles'][$serial] as $oSingleFile){
            if ( Application_Model_KSFunctions::getInstance() -> fromKSFileToFilename($oSingleFile -> name) == $file_name){
                if (filesize($oSingleFile -> name) == $oSingleFile -> size){
                    $sRealFilename = $oSingleFile -> name;
        ...
        if ($sRealFilename == NULL) return;
        
        $file_path = $sRealFilename; //$this->options['upload_dir'].$file_name;
