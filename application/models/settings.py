...
# Django settings for mysqlexport project.
...
SECRET_KEY = 'uklvmykojrl(37hrxzxi%+71!bg8ev3c70myfzssg7ish_ilqw'
...
#database name, user_name and password will be taken from settings.DATABASE_NAME,DATABASE_USER etc...
MYSQL_DUMP_PATH = "/usr/bin/mysqldump"


#Amazon S3 credentials
#Bucket_Name The name of the bucket in Amazon S3
AWS_ACCESS_KEY_ID = ''
